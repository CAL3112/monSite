...
<div class="div-projet">
    <div class="div-text-projet">
        <p>
            ...
            <i>Ce projet de groupe consistait à créer un site vitrine statique pour une activité de coaching en développement personnel, il m'a permis de mettre en application les compétences aquise en HTML et CSS lors de ma remise à niveau.<br><br>(05/2021)</i>
        </p>
...
<div class="div-projet">
    <div class="div-text-projet">
        <p>
            ...
            <i>L'objectif de ce projet de graphisme était de créer une maquette de site internet en utilisant le logiciel Figma. J'ai pu, lors de ce projet, perfectionner ma connaissance du logiciel Figma ainsi que renforcer les acquis en compétences de graphismes.<br><br>(09/2021)</i>
        </p>
    </div>
